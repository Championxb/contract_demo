...
const getSuppliers = async () => {
  try {
    ...
    supplierOptions.value = [
      { value: '上海设备制造有限公司', label: '上海设备制造有限公司' },
      { value: '北京网络设备有限公司', label: '北京网络设备有限公司' },
      { value: '深圳办公用品有限公司', label: '深圳办公用品有限公司' },
      { value: '广州市场营销有限公司', label: '广州市场营销有限公司' },
      { value: '杭州系统集成有限公司', label: '杭州系统集成有限公司' }
    ]
  } catch (error) {
